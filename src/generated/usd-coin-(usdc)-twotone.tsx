...
export const UsdCoinUsdcTwotone: React.FC<IconProps> = (props) => {
  return (
    <Icon {...props}>
      ...
      <g opacity="0.4">
      <path d="M9.66992 13.6297C9.66992 14.5297 10.3699 15.2598 11.2299 15.2598H12.9899C13.7399 15.2598 14.3499 14.6197 14.3499 13.8397C14.3499 12.9897 13.9799 12.6797 13.4199 12.4897L10.6099 11.5098C10.0599 11.3198 9.6799 11.0098 9.6799 10.1598C9.6799 9.36975 10.2899 8.73975 11.0399 8.73975H12.7999C13.6599 8.73975 14.3599 9.46975 14.3599 10.3698" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
